...
const FAQ = [
  {
    ...
    a: "После завершения звонка ассистент анализирует запись сессии и автоматически собирает протокол по формату, принятому в вашей практике. Формат можно изменить в разделе «База знаний» → «Шаблоны протоколов».",
  },
  {
